...
- [x] **Grants & Privileges** (`GRANT` / `REVOKE` on tables, functions, schemas, and columns — column-level via `grants:` under a column; `revokePublic` for functions)
